...
import { ArrowRight, User, BarChart3 } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 py-8">
      ...
      <Card className="overflow-hidden shadow-card">
        <div className="h-32 bg-gradient-to-r from-orange-200 to-orange-100 flex items-center justify-center">
      ...
      <Card className="overflow-hidden shadow-card">
        <div className="h-32 bg-gradient-to-r from-amber-100 to-yellow-100 flex items-center justify-center relative overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="absolute right-6 bottom-4 w-12 h-1 bg-amber-300/60 rounded-full transform -rotate-12"></div>
        </div>
      ...
      <div className="grid grid-cols-4 gap-1 bg-muted p-1 rounded-lg">
        ...
        <Link to="/portfolio" className="flex flex-col items-center p-3 rounded-md hover:bg-muted-foreground/10 transition-colors">
          <div className="text-lg mb-1">👤</div>
